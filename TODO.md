...
and caturing/cropping a few screenshots from the FTB App could be
very helpful.
...
the technically able, pointa-and-click instructions as a
...
to the green play button of every instance.
...
manifests, it could be worth dusting this off and adding to the book.
